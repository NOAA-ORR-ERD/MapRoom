/*
  cntr.c
  Originally from matplotlib 0.99.3  
  ...
  License agreement for matplotlib 0.99.3
  ==============================================
  ...
  derivative works, distribute, and otherwise use matplotlib 0.99.3
  alone or in any derivative version, provided, however, that JDH's
  License Agreement and JDH's notice of copyright, i.e., "Copyright (c)
  2002-2009 John D. Hunter; All Rights Reserved" are retained in
  matplotlib 0.99.3 alone or in any derivative version prepared by
  Licensee.
  
  3. In the event Licensee prepares a derivative work that is based on or
  incorporates matplotlib 0.99.3 or any part thereof, and wants to
  make the derivative work available to others as provided herein, then
  Licensee hereby agrees to include in any such work a brief summary of
  the changes made to matplotlib 0.99.3.
  
  4. JDH is making matplotlib 0.99.3 available to Licensee on an "AS
  IS" basis.  JDH MAKES NO REPRESENTATIONS OR WARRANTIES, EXPRESS OR
  IMPLIED.  BY WAY OF EXAMPLE, BUT NOT LIMITATION, JDH MAKES NO AND
  DISCLAIMS ANY REPRESENTATION OR WARRANTY OF MERCHANTABILITY OR FITNESS
  FOR ANY PARTICULAR PURPOSE OR THAT THE USE OF MATPLOTLIB 0.99.3
  WILL NOT INFRINGE ANY THIRD PARTY RIGHTS.
  
  5. JDH SHALL NOT BE LIABLE TO LICENSEE OR ANY OTHER USERS OF MATPLOTLIB
  0.99.3 FOR ANY INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES OR
  LOSS AS A RESULT OF MODIFYING, DISTRIBUTING, OR OTHERWISE USING
  MATPLOTLIB 0.99.3, OR ANY DERIVATIVE THEREOF, EVEN IF ADVISED OF
  ...
  8. By copying, installing or otherwise using matplotlib 0.99.3,
...
initcntr(void)
{
    ...
    m = Py_InitModule3("cntr", module_methods,
