...
class accumulator:
    ...
    def __init__(self, object=None, dtype=np.float, block_shape=()):
        ...
        note: a scalar accumulator doesn't really sense, so you get a length-1 array instead.
    ...
    def resize(self, newsize):
        ...
        if newsize < self._length:
            raise ValueError("accumulator buffer cannot be made smaller that the data")
