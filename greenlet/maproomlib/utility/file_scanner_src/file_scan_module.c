...
static PyObject * file_scanner_FileScanN(PyObject *self, PyObject *args)
{
    ...
    if ((i = filescan_double(PyFile_AsFile( (PyObject*)File ), length, Data)) < length){
...
static PyObject * file_scanner_FileScanN_single(PyObject *self, PyObject *args)
{
    ...
    if ((i = filescan_single(PyFile_AsFile( (PyObject*)File ), length, Data)) < length){
	    PyErr_SetString (PyExc_ValueError,
                     "End of File reached before all numbers found");
	    free(Data);
	    return NULL;
...
static PyMethodDef file_scanner_methods[] = {
  {"FileScanN_single", file_scanner_FileScanN_single, METH_VARARGS, doc_FileScanN_single},
