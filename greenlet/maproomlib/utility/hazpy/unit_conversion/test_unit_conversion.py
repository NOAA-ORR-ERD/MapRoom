...
KnownValues = [
    ...
    # and close to values in the Unit Conversion sheet distributed with the dipersion mission planner.
    ...
    ("Area", "nm^2", "square mile", 1.0, 1.3242932), # calcualted from HCP values
