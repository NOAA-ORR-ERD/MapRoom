...
class TestUnits(object):
    def test_feet(self):
        ...
        assert mi_to_rounded_string(100, area=True) == u"100.0 mi\u00b2"
        assert mi_to_rounded_string(.1, area=True) == u"528.0 ft\u00b2"
        assert km_to_rounded_string(.2, area=True) == u"200.0 m\u00b2"
        assert km_to_rounded_string(2, area=True) == u"2.0 km\u00b2"
