...
probably  should be built from a generic points layer, but maybe not..
...
class ParticleLayer(ProjectedLayer):
    """Layer for paricles from GNOME, etc.

    really just un-editable points.
    ...
    def set_data(self, f_points):
        ...
        if (n > 0):
            ...
            self.points.z[0:n] = 0 # fixme: dont need z!
    ...
    def determine_layer_color(self):
        ## fixme -- this  should be set by weather the elements are beached, or ...
        if not self.color:
