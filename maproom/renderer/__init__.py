...
if driver == "gl_immediate":
    from .gl.color import color_to_int, int_to_color, int_to_wx_color_tuple, int_to_html_color_string
    ...
    from .vispy.color import color_to_int, int_to_color, int_to_wx_color_tuple, int_to_html_color_string
    import gl.data_types as data_types
