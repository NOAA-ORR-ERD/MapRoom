...
if driver == "gl_immediate":
    from .gl.color import color_floats_to_int, color_ints_to_int, int_to_color_floats, int_to_color_uint8, int_to_html_color_string, int_to_color_ints, int_to_wx_colour, alpha_from_int
