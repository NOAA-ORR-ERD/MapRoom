...
class TextEditorPreferences(MafEditorPreferences):
    pass


class TextEditor(MafEditor):
    editor_id = "text_editor"

    ui_name = "Text Editor"

    preferences_module = "maproom.app_framework.editors.text_editor"
