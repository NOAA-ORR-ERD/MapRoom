...
if __name__ == '__main__':
    ...
    log = logging.getLogger("maproom.app_framework.editor")
    log = logging.getLogger("maproom.app_framework.editors.text_editor")
    log = logging.getLogger("maproom.app_framework.ui.error_logger")
