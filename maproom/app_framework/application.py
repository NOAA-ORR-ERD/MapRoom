...
class MafApp(wx.App):
    app_name = "MapRoom"  # user visible application name

    default_uri = "template://default_project.maproom" # when no files specified on the command line, will default to app_blank_uri
    ...
    app_error_email_to = "rob.mcmullen@noaa.gov"
...
"""
    ...
    def show_about_dialog(self):
        from .ui.dialogs import MafAboutDialog
        MafAboutDialog.show_or_raise()
